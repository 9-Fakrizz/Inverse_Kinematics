...
void setup() {
  ...
  answer output_answer_1 = calculate_IK(x, y, z, robot_link_1, 1);
  answer output_answer_2 = calculate_IK(x, y, z, robot_link_1, -1);
  ...
  calculate_FK(output_answer_2.theta0, output_answer_2.theta1, output_answer_2.theta2, robot_link_1, fk_x, fk_y, fk_z);
  Serial.println("\nForward Kinematics Check:");
  ...
  // Compare with original values
  Serial.println("\nError Check:");
  Serial.print("Error in X2: "); Serial.println(fabs(fk_x - x));
  Serial.print("Error in Y2: "); Serial.println(fabs(fk_y - y));
  Serial.print("Error in Z2: "); Serial.println(fabs(fk_z - z));
  Serial.println();
}
